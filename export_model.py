...
from CloudBaseDetection import input_preprocess
...
flags.DEFINE_integer('num_classes', 3, 'Number of classes.') #change

flags.DEFINE_multi_integer('crop_size', [482], 480],
                           'Crop size [height, width].')  #change
