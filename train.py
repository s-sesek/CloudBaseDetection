...
flags.DEFINE_string('train_logdir', './checkpoints', 'Where the checkpoint and logs are stored.')
...
flags.DEFINE_integer('training_number_of_steps', 2000000, 'The number of steps used for training')
...
def main(unused_argv):
    ...
    dataset = dataset_info.get_dataset(FLAGS.dataset, FLAGS.train_split, dataset_dir=FLAGS.dataset_dir)
